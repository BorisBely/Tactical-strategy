...
**Статус: FROZEN** (2026-08-20)  
Порядок слоёв зафиксирован. Не открывать отряд, укрытия, utility / HTN / GOAP / BT, пока не закрыт одиночный исполнительный контур и внешние источники (приказы, RoE, звук).
...
Ближайшая последовательность: **7 → 8 → 9**. Не прыгать к 13–16.
...
#6 больше не открывать. Следующее — #7.

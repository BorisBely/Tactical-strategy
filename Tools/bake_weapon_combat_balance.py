...
ROLE_CURVES: dict[str, dict[str, list[tuple[float, float]]]] = {
    ...
    "ShotgunCqb": {
        "disp": [(0, 0.72), (15, 0.95), (25, 1.45), (40, 2.40), (60, 3.90), (100, 6.00), (250, 9.00), (500, 12.00)],
        "aim": [(0, 1.05), (15, 1.18), (25, 1.45), (40, 1.95), (60, 2.80), (100, 4.20), (250, 6.20), (500, 8.50)],
        "auto": burst_role(1.00, 1.65, 3.40, 6.50),
    },
    "Carbine": {
